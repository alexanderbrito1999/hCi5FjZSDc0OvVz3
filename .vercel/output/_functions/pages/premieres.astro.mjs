...
const $$Premieres = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Premieres;
  let titles = [];
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Grid", $$Grid, { "titles": titles, "label": "ESTRENOS" })} `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "MetaTags", $$MetaTags, { "slot": "head", "title": `ESTRENOS`, "description": "Pel\xEDculas gratis online HD" })}` })}`;
}, "C:/Users/Admin/Downloads/moba-client-ssr/src/pages/premieres.astro", void 0);

const $$file = "C:/Users/Admin/Downloads/moba-client-ssr/src/pages/premieres.astro";
const $$url = "/premieres";
