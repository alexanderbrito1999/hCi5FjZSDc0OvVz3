...
const $$Tv = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    const response = await fetch(
      `${config.BACKEND_URL}/api/v1/titles_client_cluster_category?page=${page}&limit=42&available=&isMovie=false`
    );
    if (!response.ok) {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Grid", $$Grid, { "titles": titles, "label": "SERIES TV" })} `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "MetaTags", $$MetaTags, { "slot": "head", "title": `SERIES TV`, "description": "Pel\xEDculas gratis online HD" })}` })}`;
}, "C:/Users/Admin/Downloads/moba-client-ssr/src/pages/tv.astro", void 0);

const $$file = "C:/Users/Admin/Downloads/moba-client-ssr/src/pages/tv.astro";
const $$url = "/tv";
